 ...
 * rendering.
 * <p>
 * The {@link IFireproofItem} interface being injected can be marked as optional as well, removing the required
 * dependency on FutureFireproof.
 */
@Mixin(value = ItemExample.class)
@Optional.Interface(modid = "futurefireproof", iface = "com.invadermonky.futurefireproof.api.IFireproofItem", striprefs = true)
public class ItemMixinExample implements IFireproofItem {
